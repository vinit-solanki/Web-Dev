...
function About() {
  return (
    <div id='main' className='w-full h-screen flex flex-col md:flex-row items-center bg-black p-3 overflow-hidden'>
      ...
      <div className='w-full md:w-1/2 flex justify-center items-center'>
        <Lottie animationData={AboutVideo} className="w-full h-auto max-w-md" />
      </div>
    </div>
  );
}
