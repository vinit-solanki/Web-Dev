...
function Projects() {
  return (
    <div id='project-container' className='relative w-full h-100 bg-black flex flex-col items-center justify-center p-4 '>
      <div className='relative flex flex-col md:flex-col items-center justify-center bg-black shadow-lg rounded-lg max-w-6xl mx-4 md:mx-8 gap-y-10'>
